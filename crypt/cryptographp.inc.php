...
include_once($_SESSION['configfile']);  
...
for ($i=1;$i<= $charnb;$i++) {              
     ...
     putenv('GDFONTPATH='.getcwd()."/fonts/");
     $lafont=$tword[$i]['font'];
     //if (strpos(strtoupper($lafont), ".TTF") == strlen($lafont)-4) $lafont = substr ($lafont,0,strlen($lafont)-4);
	 imagettftext($imgtmp,$tword[$i]['size'],$tword[$i]['angle'],$x,$tword[$i]['y'],$black,"./fonts/".$lafont,$tword[$i]['element']);
...
for ($i=1;$i<= $charnb;$i++) {       
    ...
    $lafont=$tword[$i]['font'];
    //if (strpos(strtoupper($lafont), ".TTF") == strlen($lafont)-4) $lafont = substr ($lafont,0,strlen($lafont)-4);
    imagettftext($img,$tword[$i]['size'],$tword[$i]['angle'],$x,$tword[$i]['y'],$charcolorrnd?$rndink:$ink,"./fonts/".$lafont,$tword[$i]['element']);
