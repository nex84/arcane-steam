...
echo "0 2,14 * * * root if [ -e /etc/letsencrypt/live/arcane-steam.com/privkey.pem ] ; then aws s3 cp /etc/letsencrypt/live/arcane-steam.com/privkey.pem s3://nex84-admin-s3/pki/arcane-steam.com.key" >> /etc/cron.d/arcane-steam_pki_backup
