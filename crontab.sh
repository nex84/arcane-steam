...
echo "0 2,14 * * * root if [ -e /etc/letsencrypt/live/arcane-steam.com/fullchain.pem ] ; then aws s3 cp /etc/letsencrypt/live/arcane-steam.com/fullchain.pem s3://nex84-admin-s3/pki/arcane-steam.com.crt ; fi"  > /etc/cron.d/arcane-steam_pki_backup
